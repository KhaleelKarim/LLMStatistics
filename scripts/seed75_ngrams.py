...
from src.ngrams import load_docs, build_tokenizer, compute_ngram_distribution, save_ngrams
...
if __name__ == "__main__":
    ...
    base_path = "data/infer_seed75_embd16_layer1_blk16_n32000_step"

    for step in range(0, 32001, 1000):
        infer_path = base_path + str(step) + ".txt"
        out_path = build_output_ngrams_path(infer_path)
        ...
        infer_docs = load_docs(infer_path)
